						...
						<div class="row">
							...
							<div class="col-md-6 sheet-div">
								...
								<div class="row" id="criteria" ng-repeat="criteria in team.criteria">
										...
										<div class="col-md-4">
											<h4><input type="number" class="text-right" name="criteria-{{criteria.criteria_id}}" style="width: 4em;" ng-model="criteria.score" ng-change="updateScore(team)" placeholder="0" value="{{criteria.score}}"/><span> / {{criteria.criteria_weight}}</span></h4>
										</div>
